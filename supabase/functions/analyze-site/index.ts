...
- "heroUrl": URL absoluto de uma FOTO grande e apelativa do hotel (paisagem, fachada, piscina, quarto, vista) para usar como imagem de topo do email. Tipicamente a og:image ou a maior foto do site. NÃO o logótipo, NÃO um ícone. null se não houver foto adequada.
